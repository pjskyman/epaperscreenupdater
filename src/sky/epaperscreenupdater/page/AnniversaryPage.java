...
public class AnniversaryPage extends AbstractSinglePage
{
    ...
    {
        List<Entry<Birthday,String>> anniversaries=getAnniversaries();
    ...
    public static List<Entry<Birthday,String>> getAnniversaries() throws IOException
    {
    ...
    public static boolean isAnniversaryToday(List<Entry<Birthday,String>> anniversaries)
    {
        GregorianCalendar nowCalendar=new GregorianCalendar();
        for(int i=0;i<anniversaries.size();i++)
        {
