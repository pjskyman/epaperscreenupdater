...
public class HomeWeatherPage extends AbstractSinglePage
{
    ...
    protected void populateImage(Graphics2D g2d) throws VetoException,Exception
    {
        ...
        Temperature temperature=Database.getLastTemperature();
        Measure lastToiletsTemperature=temperature==null?null:new StandAloneMeasure(new Date(temperature.getTime()),MeasurementType.TEMPERATURE,temperature.getTemperature());
